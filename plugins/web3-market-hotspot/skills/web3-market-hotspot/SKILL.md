...
🔍 圈内动态（交易所 · 链·生态 · 老板高管 · 孙哥 · 币圈KOL · 特朗普）
  5-10 条，每条 = 标题 + 内容摘要 + 信息来源。取自 report.py 的「圈内动态」或按主体在新闻/社媒/宏观里定向捞取。
  监测主体：交易所(上/下架·公告·新合约)、链·生态(主网·升级·安全事件·TVL·空投)、交易所老板高管(CZ/Coinbase CEO 等)、孙哥(孙宇晨/波场)、币圈KOL(名人·巨鲸·观点)、特朗普(加密相关: 数字资产/制裁/监管/ETF)。
  1. <一句话标题>
  · 摘要：<一句话>
  · 来源：<媒体>

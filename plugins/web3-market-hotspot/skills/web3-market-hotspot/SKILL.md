...
面向 Web3 / 美股内容创作者：**3 分钟抓住核心热点、直接开写**。每个热点均按**素材包标准**交付（主题/硬数据/新闻标题/原声/角度）；创作者提示词框架**附文档末尾**。来源只在文末统一标注，正文不刷来源噪音。
**每周一**：同时交付**两份文档** —— ① 日报（今日内容简报）② 周报（本周回顾 + 下周可预估热点）；两者均按素材包标准，框架附各自文末。

```
【Web3 · 美股 内容创作者热点简报｜M月D日】

🔥 今日核心看点（3–5 条，每条按素材包标准）
  #1 《一句话标题》
   · 主题：一句话：讲什么热点 + 逻辑/背景（1–2 句）
   · 硬数据：2–3 个关键数字（价格/涨跌/资金/异动）
   · 新闻标题：1–2 条真实标题（含媒体名）
   · 原声：1 条社区/网友原声

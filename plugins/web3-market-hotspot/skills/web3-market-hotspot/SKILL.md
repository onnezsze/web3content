...
🕐 周度回顾（周一简报专属 · v7.7 新增）
  ...
  ② 本周可预估热点：当周已知/大概率将发生的事件；取 report.py 输出的「本周可预估热点候选」，按**三级优先级**排序：
     ● 高：美联储动态（加息/降息/利率/就业数据·非农/CPI·PCE·通胀 等）+ 美股明星股财报动态（Nvidia/苹果/特斯拉/微软/谷歌/AMD/台积电/MAG7 等）。
     ● 中：BTC / ETH / SOL / MEME 等主流加密货币币种热点。
     ● 低：其他加密/美股/日韩股票/港股/A股（创业板/科创板/A股）。
  格式（每条四要素）：
  📅 【上周回顾】／【本周预估】
   1. <日期，如 8/21> <一句话标题>
    · 摘要：<一句话讲清事件>
